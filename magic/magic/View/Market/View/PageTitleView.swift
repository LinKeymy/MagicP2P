...
//  magic
//
//  Created by SteveLin on 2017/5/5.
...
private let kSelectColor :(CGFloat,CGFloat,CGFloat) = (0,0,0)
...
class PageTitleView: UIView {
    ...
    var isHiddenBttomSeparator = false {
        didSet {
          bottomLine.isHidden = isHiddenBttomSeparator
        }
    }
    ...
    fileprivate lazy var scrollLine : UIView = {
        ...
        scrollLine.backgroundColor = UIColor.black
        return scrollLine
    }()
...
extension PageTitleView {
    @objc fileprivate func titleLabelClick(_ tapGes:UITapGestureRecognizer) {
        if !tapGes.responds(to: #selector(getter: UIGestureRecognizer.view)) {
            return
        }
...
extension PageTitleView{
    func setTitleWithProgress(_ progress:CGFloat,sourceIndex : Int,targetIndex : Int){
        ...
        //        scrollLine.frame = sourceLabel.frame.offsetBy(dx:  sourceLabel.frame.width*0.1 + moveX, dy: 0)
